...
public class TaskService : ITaskService
{
    ...
    public async Task<IEnumerable<TaskResponseDto>> GetTasksByUserAsync(string userId, bool? isComplete = null, string? priority = null)
    {
        var tasks = await _repository.GetByUserIdAsync(userId, isComplete, priority);
        return _mapper.Map<IEnumerable<TaskResponseDto>>(tasks);
    }
