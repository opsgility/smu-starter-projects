# google-ai-100-review-summarizer
...
- `summarize.py` — CLI skeleton with `TODO`s
- `reviews.csv` — 20 sample reviews (product, rating, review_text)
- `requirements.txt`
- `NOTES.md` — blank file for your observations in Part 4
