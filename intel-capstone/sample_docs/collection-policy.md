...
- Public newswire and broadcast transcripts the bureau has a
  redistribution license for.
- Public threat-intelligence feeds the bureau subscribes to (open-source
  phishing kits, public IOC lists, public AIS data).
