...
public class Post {
    ...
    // TODO Exercise 1: Add @Version private Long version;
    // This enables optimistic locking — JPA will check version on every UPDATE.
    // If two requests read the same post and both try to save, the second will throw OptimisticLockException.
