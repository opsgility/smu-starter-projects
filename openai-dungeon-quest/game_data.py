...
ROOM_COORDS = {
    # Village (tavern anchor; north = y decreases)
    "tavern":            (6, 7),
    "town_square":       (6, 6),
    "graveyard":         (6, 5),
    "temple":            (4, 6),
    ...
    "mystics_shop":      (8, 5),
    "blacksmith":        (8, 7),
    # Forest (west of tavern, going north & deeper west)
    "forest_clearing":   (4, 7),
    "river_crossing":    (2, 7),
    "ancient_ruins":     (0, 7),
    "wolf_den":          (2, 6),
    ...
    "hidden_grove":      (6, 4),
    "wizard_tower":      (4, 3),
    # Upper dungeon (east of tavern, going north)
    "dungeon_entrance":  (10, 7),
    "dungeon_corridor":  (10, 6),
    "treasure_room":     (9, 6),
    "guard_room":        (11, 6),
    "mushroom_cavern":   (12, 6),
    "spider_queen_lair": (12, 7),
    "torture_chamber":   (10, 5),
    # Deep dungeon (continuing north from torture_chamber)
    "underground_river": (10, 4),
    "prison_cells":      (9, 4),
    "crypt":             (11, 4),
    "alchemist_lab":     (11, 3),
    "ritual_chamber":    (11, 2),
